...
// Enter the size of the input array (N): 4
// Enter the size of the convolution kernel (M): 3
// Enter the elements of the input array N (size 4):
// N[0] = 1
// N[1] = 2
// N[2] = 3
// N[3] = 4
// Enter the elements of the convolution kernel M (size 3):
// M[0] = 6
// M[1] = 4 
// M[2] = 2
